...
extern "C" void
Java_com_dy_colony_usbcamera_UvcCameraPreview_pixeltobmp(JNIEnv *env, jobject thiz,
                                                      jobject bitmap) {
   if (fd==-1){
       return;
   }
...
extern "C" jint
Java_com_dy_colony_usbcamera_UvcCameraPreview_prepareCamera(JNIEnv *env, jobject thiz,
                                                         jint videoid,
                                                         jint width,
                                                         jint hight) {
    IMG_WIDTH = width;
    ...
    if (ret != ERROR_LOCAL) {
        rgb = (int *) malloc(sizeof(int) * (width * hight));
        ybuf = (int *) malloc(sizeof(int) * (width * hight));
    }
    return ret;
}
...
extern "C" jint
Java_com_dy_colony_usbcamera_UvcCameraPreview_prepareCameraWithBase(JNIEnv *env, jobject thiz,
                                                                 jint videoid,
                                                                 jint videobase,
                                                                 jint width,
                                                                 jint hight) {
    ...
    return Java_com_dy_colony_usbcamera_UvcCameraPreview_prepareCamera(env, thiz, videoid,
                                                                    width, hight);

}

extern "C" void
Java_com_dy_colony_usbcamera_UvcCameraPreview_processCamera(JNIEnv *env, jobject thiz) {

    readframeonce();
}

extern "C" void
Java_com_dy_colony_usbcamera_UvcCameraPreview_stopCamera(JNIEnv *env, jobject thiz) {
