 ...
 */
public class SampleMessageAdapter extends BaseQuickAdapter<BaseSampleMessage, BaseViewHolder> {
    private Context mContext;

    public SampleMessageAdapter(int layoutResId, @Nullable List<? extends BaseSampleMessage> data, Context context) {
    ...
    protected void convert(BaseViewHolder helper, BaseSampleMessage item) {
        ...
        if (item instanceof FoodItemAndStandard) {
            ...
            helper.setVisible(R.id.sample_delete, true)
