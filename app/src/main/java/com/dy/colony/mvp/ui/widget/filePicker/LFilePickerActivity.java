package com.dy.colony.mvp.ui.widget.filePicker;
...
public class LFilePickerActivity extends BaseActivity {
    ...
    private void initToolbar() {
        ...
        if (mParamEntity.getTitle() != null) {
            ...
            getSupportActionBar().setTitle(R.string.pleacechosefile);
        }
...
//        }
    ...
    private void updateAddButton() {
       ...
       /* if (!mMutilyMode) {
        ...
        if (!mChooseMode) {
            ...
            mBtnAddBook.setText(getString(R.string.sure));
            //文件夹模式默认为单选模式
    ...
    public void updateMenuTitle() {
        ...
        if (mIsAllSelected) {
            ...
            mMenu.getItem(0).setTitle(getString(R.string.select_all));
        }
    }
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        mChooseMode = mParamEntity.isChooseMode();
        mMutilyMode = mParamEntity.isMutilyMode();
        initView();
        initToolbar();
