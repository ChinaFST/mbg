...
public final class DefaultErrorActivity extends FragmentActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/coffee/errorlogs/";
        String intent = CustomActivityOnCrash.getAllErrorDetailsFromIntent(DefaultErrorActivity.this, getIntent());
        FileUtils.writeTxtToFile(intent,path,System.currentTimeMillis()+".txt");
        if (config.isShowErrorDetails()) {
            moreInfoButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.dp_10));
                }
            });
        } else {
