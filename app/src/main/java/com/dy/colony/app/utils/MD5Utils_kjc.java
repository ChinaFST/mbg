 ...
 * 　　　　　┗┻┛　┗┻┛
 * <p>
 * Created by wangzhenxiong on 2020/6/10.
 */
public class MD5Utils_kjc {

    public static String md5_32_low(String string) {
     ...
     * @return
     */
    public static MD5Utils_kjc getInit() {
        return new MD5Utils_kjc();
    }
