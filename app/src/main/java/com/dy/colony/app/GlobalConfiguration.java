...
import com.dy.colony.app.jsonFactory.FastJsonConverterFactory;
import com.dy.colony.app.utils.AppUtils;
...
//                })
                ...
                //可以自定义一个单例的线程池供全局使用
                .executorService(new ScheduledThreadPoolExecutor(AppUtils.getNumCores(), new WorkerThreadFactory()))
