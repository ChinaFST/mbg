 ...
 * 　　　　　┗┻┛　┗┻┛
 * <p>
 * Created by wangzhenxiong on 2019-12-05.
 * 处理返回不规范问题，比如直接返回一段字符串
 */
public class LenientGsonConverterFactory extends Converter.Factory {
   ...
   /* public class LenientGsonRequestBodyConverterzhj<T> implements Converter<T, RequestBody> {
        ...
        LenientGsonRequestBodyConverterzhj(Gson gson, TypeAdapter<T> adapter) {
            this.gson = gson;
            this.adapter = adapter;
        }
