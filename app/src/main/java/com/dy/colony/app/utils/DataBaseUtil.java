...
public class DataBaseUtil {
    private static final String DATABASE_PATH = "/data/data/" + BuildConfig.APPLICATION_ID + "/databases/";// 数据库在手机里的路径
     ...
     * @throws IOException
     */
    public static void copyDataBase(Context context, int R, String dbName) throws IOException {
